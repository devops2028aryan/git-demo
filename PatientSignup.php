                    ...
                    <div class="bg-light text-center rounded p-5">
                        ...
                        <form action="Patient.php" method="post" enctype="multipart/form-data">
                            <div class="row g-3">
                                ...
                                <div class="col-12">
                                    <input type="number" class="form-control bg-white border-0" placeholder="Patient Mobile Number" style="height: 35px;" name="PatientMobileNumber">
                                </div>
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    <label for="doctor image">Patient Image</label>
                                    <input type="file" class="form-control bg-white border-0" placeholder="Patient Image" style="height: 35px;" name="PatientImage">
                                </div>
                                
                                <div class="col-12">
                                    <button class="btn btn-primary w-100 py-3" value="Submit_Patient" type="submit">Sumbit</button>
                                </div>
                            </div>
                        </form>
                    </div>
