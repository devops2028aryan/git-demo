...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM patientsignup WHERE PatientEmail='$PatientEmail'";
    $result = $con->query($sql);

    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        if ($row['Password'] === $Password) {
            header("Location: Paitent_Index.php");
        } else {
                    ...
                    <div class="navbar-nav ms-auto py-0">
                        ...
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu m-0">
                                ...
                                <a href="PatientLogin.php" class="dropdown-item active">Patient Log-In</a>
            ...
            <div class="div1">
                ...
                <div class="div">
                    <div class="bg-light text-center rounded p-5">
                        <h1 class="mb-4">Patient Log-In</h1>
                        <form action="PatientLogin.php" method="post">
                            <div class="row g-3">
                                <div class="col-12">
                                    <input type="email" class="form-control bg-white border-0" placeholder="Patient Email" style="height: 45px;" name="PatientEmail">
                                </div>
                                <div class="col-12">
